...
import { Search, BookOpen, AlertCircle, Mail, MessageSquare, ArrowRight } from 'lucide-react';
import Link from 'next/link';

export const metadata = {
  title: 'Help Center | Soovia eSIM',
  description: 'How can we help you? Browse support categories, eSIM installation guides, troubleshooting, and 24/7 customer support.',
};
              ...
              >
                <div>
                  ...
                  <p className="text-slate-500 mb-6 text-sm md:text-base leading-relaxed">
                    Step-by-step guides to install and activate your eSIM on any compatible device.
                  </p>
                </div>
